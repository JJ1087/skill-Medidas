...
const languageStrings = {
    en: {
        translation: {
            WELCOME_MESSAGE: 'Welcome to skill convertidor jeziel. What would you like to convert?',
            HELP_MESSAGE: 'You can ask me to convert length units, for example: convert ten meters to feet. How can I help you?',
    ...
    es: {
        translation: {
            WELCOME_MESSAGE: 'Bienvenido al skill convertidor jeziel. ¿Qué te gustaría convertir?',
            HELP_MESSAGE: 'Puedes pedirme que convierta unidades de longitud, por ejemplo: convierte diez metros a pies. ¿Cómo puedo ayudarte?',
...
const ConvertidorIntentHandler = {
    ...
    handle(handlerInput) {
        ...
        let speakOutput = 'Skill convertidor jeziel. ';
...
const LaunchRequestHandler = {
    ...
    handle(handlerInput) {
        const requestAttributes = handlerInput.attributesManager.getRequestAttributes();
        const speakOutput = 'Skill convertidor jeziel. ' + requestAttributes.t('WELCOME_MESSAGE');
...
const HelpIntentHandler = {
    ...
    handle(handlerInput) {
        const requestAttributes = handlerInput.attributesManager.getRequestAttributes();
        const speakOutput = 'Skill convertidor jeziel. ' + requestAttributes.t('HELP_MESSAGE');
...
const CancelAndStopIntentHandler = {
    ...
    handle(handlerInput) {
        const requestAttributes = handlerInput.attributesManager.getRequestAttributes();
        const speakOutput = 'Skill convertidor jeziel. ' + requestAttributes.t('GOODBYE_MESSAGE');
...
const FallbackIntentHandler = {
    ...
    handle(handlerInput) {
        const requestAttributes = handlerInput.attributesManager.getRequestAttributes();
        const speakOutput = 'Skill convertidor jeziel. ' + requestAttributes.t('FALLBACK_MESSAGE');
...
const IntentReflectorHandler = {
    ...
    handle(handlerInput) {
        ...
        const speakOutput = 'Skill convertidor jeziel. ' + requestAttributes.t('REFLECTOR_MESSAGE', intentName);
...
const ErrorHandler = {
    ...
    handle(handlerInput, error) {
        const requestAttributes = handlerInput.attributesManager.getRequestAttributes();
        const speakOutput = 'Skill convertidor jeziel. ' + requestAttributes.t('ERROR_MESSAGE');
